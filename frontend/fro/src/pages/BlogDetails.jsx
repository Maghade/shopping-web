...
export default function BlogDetails() {
  return (
    <>
          ...
          <div className="row">
              ...
              <div className="blog__sidebar">
                ...
                <div className="blog__sidebar__item">
                  ...
                  <div className="blog__sidebar__recent">
                    ...
                    <a href="#" className="blog__sidebar__recent__item">
                      <div className="blog__sidebar__recent__item__pic">
                        <img src="/assets/recent-2.jpg" alt="" />
                      </div>
                      <div className="blog__sidebar__recent__item__text">
                        <h6>
                    ...
                    <a href="#" className="blog__sidebar__recent__item">
                      <div className="blog__sidebar__recent__item__pic">
                        <img src="/assets/recent-3.jpg" alt="" />
                      </div>
                      <div className="blog__sidebar__recent__item__text">
                        <h6>
            ...
            <div className="col-lg-8 col-md-7 order-md-2 order-1">
              <div className="blog__details__text">
                <img src="/assets/blog-details.jpg" alt="" />
                <p>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="blog__item">
                <div className="blog__item__pic">
                  <img src="/assets/blog-item-1.jpg" alt="" />
                </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="blog__item">
                <div className="blog__item__pic">
                  <img src="/assets/blog-item-2.jpg" alt="" />
                </div>
                <div className="blog__item__text">
                  <ul>
                    <li>
            ...
            <div className="col-lg-4 col-md-4 col-sm-6">
              <div className="blog__item">
                <div className="blog__item__pic">
                  <img src="/assets/blog-item-3.jpg" alt="" />
                </div>
                <div className="blog__item__text">
                  <ul>
                    <li>
      ...
      {/* JS Plugins (can be loaded via useEffect or external script) */}
    </>
  );
}